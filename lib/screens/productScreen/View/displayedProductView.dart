          ...
          child: FloatingActionButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) =>  Add_Product(shopId: widget.shopId)));
            },
            backgroundColor: kWhite,
            child: const Icon(
              Icons.add,
          ...
          return Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                if (sortedMap.containsKey("size"))
                  {
                    sortedMap.clear();
                  }
                else
                  {
                    dropdownValues.putIfAbsent(products[index].product_name, () => sortedMap.keys.first);
                  }
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height: mqh * 110 / 2340,
                                child: Text(
                                  sortedMap.isEmpty ? "₹${product.min_price}" : "₹${sortedMap[dropdownValues[product.product_name]]}",
                                  textDirection: TextDirection.ltr,
                        ...
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                               !sortedMap.isEmpty ? DropdownButton<String>(
